        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about-us" className="text-gray-300 hover:text-amber-500">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/products" className="text-gray-300 hover:text-amber-500">
                  Shop
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-gray-300 hover:text-amber-500">
                  FAQ
                </Link>
              </li>
              <li>
                <Link to="/contact-us" className="text-gray-300 hover:text-amber-500">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-300 hover:text-amber-500">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link to="/return-policy" className="text-gray-300 hover:text-amber-500">
                  Return Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products?category=cement" className="text-gray-300 hover:text-amber-500">
                  Cement
                </Link>
              </li>
              <li>
                <Link to="/products?category=bricks" className="text-gray-300 hover:text-amber-500">
                  Bricks & Blocks
                </Link>
              </li>
              <li>
                <Link to="/products?category=tiles" className="text-gray-300 hover:text-amber-500">
                  Tiles
                </Link>
              </li>
              <li>
                <Link to="/products?category=steel" className="text-gray-300 hover:text-amber-500">
                  Steel
                </Link>
              </li>
              <li>
                <Link to="/products?category=plumbing" className="text-gray-300 hover:text-amber-500">
                  Plumbing
                </Link>
              </li>
              <li>
                <Link to="/products?category=paint" className="text-gray-300 hover:text-amber-500">
                  Paint
                </Link>
              </li>
              <li>
                <Link to="/products?category=tools" className="text-gray-300 hover:text-amber-500">
                  Tools
                </Link>
              </li>
            </ul>
