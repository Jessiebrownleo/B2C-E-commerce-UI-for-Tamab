...
const Home = () => {
  ...
  const pageDescription = 'Discover high-quality construction materials and building supplies at TAMAB CONSTRUCTION. We offer competitive prices, fast delivery, and expert advice for all your construction needs in Cambodia.';
  const pageKeywords = [
  ...
  const pageImage = 'https://upload.wikimedia.org/wikipedia/en/thumb/4/47/FC_Barcelona_%28crest%29.svg/640px-FC_Barcelona_%28crest%29.svg.png'; // Replace with your actual image URL
  const categories = [{
    id: 'cement',
    name: 'Cement',
